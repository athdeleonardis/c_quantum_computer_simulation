...
int main(int argc, char *argv[]) {
    ...
    int to_swap2[] = { 2, 0 };
    qugate_swap(0, to_swap0, qin, qout0);
    qugate_swap(0, to_swap1, qout0, qout1);
    qugate_swap(0, to_swap2, qout1, qout0);
    qugate_swap(0, to_swap1, qout0, qout1);
    printf("Swapped qubits 01, 12, 20, 12 (Identity)\n");
    xiym_print(&qout1->vals);

    qugate_q01cnot(0, 0, qin, qout0);
